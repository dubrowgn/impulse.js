...
var intersect = (function() {
	...
	intersect.mouseMove = function(e) {
		...
		// back-translate mouse position into world coordinates
		var pos = new Vector(e.x, e.y).add(_mouseOffset);
		pos.applyTransform(_camera.getRenderMatrix().invert());
